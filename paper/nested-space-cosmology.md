...
Its homogeneous shift component excludes the no-interface truncation, while
the extended component gate isolates the transmitting boundary-action selector.
